...
import com.ss.ugc.android.alpha_player.utils.ShaderUtils
...
class MaskShader(edgeBlurBoolean : Boolean) {
    ...
    init {
        program = if(edgeBlurBoolean) ShaderUtils.createProgram(VERTEX, FRAGMENT_BLUR_EDGE) else ShaderUtils.createProgram(
            VERTEX, FRAGMENT_NO_BLUR_EDGE
        )
